...
module.exports =
  (pluginOptions = {}) =>
  async (nextConfig = {}) => {
    const colors = pluginOptions?.colors || defaultColors
    const darkThemeFilePath = "./src/styles/2-theme/_dark.scss"
    const lightThemeFilePath = "./src/styles/2-theme/_light.scss"

    await fs.writeFile(lightThemeFilePath, getLightTemplate(colors), {})
    await fs.writeFile(darkThemeFilePath, getDarkTemplate(colors), {})
